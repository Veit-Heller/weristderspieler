...
// Prueft ob der eingegebene Text dem Spielernamen aehnlich genug ist
// Toleriert bis zu maxErrors Rechtschreibfehler
export const fuzzyMatch = (input, playerName, maxErrors = 2) => {
